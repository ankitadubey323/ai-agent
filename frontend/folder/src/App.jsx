...
export default function App() {
  ...
  function speak(text) {
    ...
    utt.onstart = () => { setIsSpeaking(true);  setStatus('speaking') }
    utt.onend   = () => { setIsSpeaking(false); setIsRecording(false); setStatus('ready') }
    utt.onerror = () => { setIsSpeaking(false); setIsRecording(false); setStatus('ready') }
